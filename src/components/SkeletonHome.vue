<script setup lang="ts">
    ...
    import {RouteCount} from '@/pages/index';
    import {
        Table,
        TableBody,
        TableCell,
...
<template>
    <div class="grid gap-4 mb-4 md:grid-cols-2 lg:grid-cols-4">
        <Card v-for="index in 4" :key="index">
            <CardHeader>
                <CardTitle><Skeleton class="h-6 w-[150px]" /></CardTitle>
            </CardHeader>
    ...
    <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <Card>
            <CardContent>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead><Skeleton class="h-4 w-8" /></TableHead>
                            <TableHead><Skeleton class="h-4 w-60" /></TableHead>
                            <TableHead><Skeleton class="h-4 w-full" /></TableHead>
                            <TableHead><Skeleton class="h-4 w-20" /></TableHead>
                            <TableHead><Skeleton class="h-4 w-30" /></TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        <TableRow v-for="index in 10" :key="index">
                            <TableCell><Skeleton class="h-4 w-8" /></TableCell>
                            <TableCell><Skeleton class="h-4 w-60" /></TableCell>
                            <TableCell><Skeleton class="h-4 w-full" /></TableCell>
                            <TableCell><Skeleton class="h-4 w-20" /></TableCell>
                            <TableCell><Skeleton class="h-4 w-30" /></TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
            </CardContent>
        ...
        <Card class="flex flex-col justify-center items-center">
            <CardHeader class="flex flex-col justify-center items-center">
                <CardTitle><Skeleton class="h-8 w-60" /></CardTitle>
            </CardHeader>
            <CardContent>
                <VisXYContainer
